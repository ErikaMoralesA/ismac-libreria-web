...
<section class="px-5 py-5">
    <div class="container">
        ...
        <div class="container" style="text-align: center">
            <button class="btn btn-primary" onclick="window.location.href='/ismac-libreria-web-noc/libros2/findOne?opcion=1'; return false">
            ...
            <table id="tabla1"
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="N° de páginas" data-sortable="true">numPaginas</th>
                ...
                <tbody>
                    <c:forEach var="item" items="${libros}">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success" onclick="window.location.href='/ismac-libreria-web-noc/libros2/findOne?idLibro=${item.idLibro}&opcion=1';return false;">
                                     <i class="fa-solid fa-arrows-rotate"></i>
                                </button>
                                <button class="btn btn-danger" onclick="window.location.href='/ismac-libreria-web-noc/libros2/findOne?idLibro=${item.idLibro}&opcion=2';return false;">
